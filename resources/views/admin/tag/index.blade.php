...
@section('content')
    <div class="row">
        <div class="d-flex justify-content-between mb-2">
            <h3>Tags List</h3>
            <a class="btn btn-success" href="{{ route('create_tag') }}" role="button">
                    ...
                    <tbody>
                        @foreach ($tags as $key => $tag)
                            <tr>
                                ...
                                <td>
                                    <a class="btn  btn-sm" href="{{ route('edit_tag', $tag->id) }}" role="button"><svg
                                ...
                                <td>
                                    <a class="btn  btn-sm" href="{{ route('delete_tag', $tag->id) }}"
