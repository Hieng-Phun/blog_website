...
@section('content')
    <div class="row">
        <div class="d-flex justify-content-between mb-2">
            <h3>Category List</h3>
            <a class="btn btn-success" href="{{ route('create_category') }}" role="button">
                    ...
                    <tbody>
                        @foreach ($categories as $key => $category)
                            <tr>
                                ...
                                <td>
                                    <a class="btn  btn-sm" href="{{ route('edit_category', $category->id) }}"
                                ...
                                <td>
                                    <a class="btn  btn-sm" href="{{ route('delete_category', $category->id) }}"
